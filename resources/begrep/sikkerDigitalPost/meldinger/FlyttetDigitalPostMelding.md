...
sidebar: dpi_sidebar
redirect_from: /sdp_flyttetdigitalpostmelding
---

|---|---|
| Identifikator | |
| Term          | {{page.title}} |
| Definisjon    | En digital post med tilhørende [Dokumentpakke]({{site.baseurl}}/resources/begrep/felles/) som flyttes fra en postkasseleverandør til en annen |
| Kilde         | DIFI |
