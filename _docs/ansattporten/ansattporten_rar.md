...
|org_hint | Valgfri | Begrense organisasjonsvelger til én bestemt virksomhet ved å oppgi et 9-sifret organisasjonsnummer. Dersom satt i flere autorisasjonsobjekter, må alle ha samme verdi. | Gjelder på tvers av alle autorisasjonsobjekter - må ha samme verdi dersom spesifisert i flere autorisasjonsobjekter |
...
*Eksempel på request som låser organisasjonsvelger til én bestemt virksomhet ved hjelp av `org_hint`*: 
```
  authorization_details= [
    {
      "type": "ansattporten:altinn:resource",
