...
En tjenesteeier kan velge å assosiere ulike *tjenestespesifikke rettigheter* ved en klient som bruker Virksomhetsbroen, for eksempel `les` eller `rapporter`.  Dette er fritekstverdier som da gir kontekstuell mening kun inne i tjenesteeiers tjeneste, for eksempel brukt til tilgangstyring inne i tjenesten.  Tjenesteeier må i sin dokumentasjon fortelle arbeidsgivere at tjenesten støtter og/eller krever slike tjenestespesifikke rettigheter, og hvilke verdier som brukes.
...
## Hvordan administrere Virksomhetsbroen?
...
I testmiljøet tilbyr vi innlogging med TestID. Da kan du logge inn som en fiktiv daglig leder, og sette opp en virksomhetsbro på vegne av virksomheten.
...
**Domene:** Brukes for å la brukere representere virksomheten på domenenivå. F.eks digdir.no
...
![Skjermbilde som viser de tilgjengelige fanene]({{site.baseurl}}/assets/ansattporten_virkbro_identifikatortype_fane.png)

## Filtertyper

Filtertyper brukes for å finjustere konfigurasjonen. Per i dag finnes det 3 filtertyper.
...
For å åpne for at enkelte e-postadresser kan representere virksomheten i EntraID, angi e-postadresse og sett filtertype til "Tillat alle".
...
Dersom du vil la en enkelt e-postadresse representere virksomheten på spesifikke klienter, angi e-postadresse, sett filtertype til "Tillat kun" og angi KlientID i en kommaseparert liste.
...
Dersom du vil la en enkelt e-postadresse representere virksomheten med noen unntak, angi e-postadresse, sett filtertype til "Tillat alle utenom" og angi KlientID i en kommaseparert liste.
...
For å åpne for at alle brukere med et gitt domene kan representere virksomheten, angi domene og sett filtertype til "Tillat alle".
...
Dersom du vil la brukere representere virksomheten på spesifikke klienter, angi domene, sett filtertype til "Tillat kun" og angi KlientID i en kommaseparert liste.
...
For å la brukere representere virksomheten på alle tjenester utenom X, angi domene, sett filtertype til "Tillat alle utenom" og angi KlientID i en kommaseparert liste.

I dette eksempelet vil brukere med digdir.no domene kunne bruke EntraID til å representere virksomheten på alle klienter utenom 9a99e96d-b56c-4f74-a689-f936f71c8819.
...
For å åpne for at alle brukere med i en gitt EntraID-gruppe kan representere virksomheten, angi GUID for gruppen og sett filtertype til "Tillat alle".
...
Dersom du vil la brukere i en utvalgt EntraID-gruppe representere virksomheten på spesifikke klienter, angi GUID for gruppen, sett filtertype til "Tillat kun" og angi KlientID i en kommaseparert liste.
...
Dersom du vil la brukere i en utvalgt EntraID-gruppe representere virksomheten med noen unntak, angi GUID for gruppen, sett filtertype til "Tillat alle utenom" og angi KlientID i en kommaseparert liste.
