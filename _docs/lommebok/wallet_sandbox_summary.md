...
Norwegian public and private sector companies can test the issuance and consumption of verifiable credentials in a controlled environment, to see if the Wallet allows us to build better digital services than the ones we have today.  The sandbox should be leveraged by Norwegian Trust Service Providers to learn what will be required from them in order to take on the new roles introduced by the Regulation and the opportunities by gaining  access to the European Single Digital Market. 

The sandbox will be connected to othern countries, as it shall be used by Norwegian particiants in the WeBuild Large Scale Pilot.

The sandbox was lauched in October 2025.

## Available ecosystem services

The Norwegian Digitalisation Agency (Digdir) develop and operate several of the central components which are needed for the ecosystem to work.  
