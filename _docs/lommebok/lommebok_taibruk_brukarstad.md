...
Du kan sjå i [beviskatalogen](beviskatalog) for å finne kva typar bevis som allereie er tilbode i sandkassen.  For utprøving er det nyttig å mock'e data med [Bevisgenerator](bevisgenerator).
