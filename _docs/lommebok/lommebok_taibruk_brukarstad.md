...
Du kan sjå i [beviskatalogen](https://innsyn.test.eidas2sandkasse.net/) for å finne kva typar bevis som allereie er tilbode i sandkassen.  For utprøving er det nyttig å mock'e data med [Bevisgenerator](https://bevisgenerator.test.eidas2sandkasse.net/).
