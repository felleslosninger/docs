...
{% include note.html content="Dersom du berre ynskjer å prøve ut bevis-produksjon på ein enkel måte, kan du bruke sandkassa sin [Bevisgenerator](lommebok_digdir_utsteder_bevisgenerator)." %}
