...
> URL til test-tenesteeigar tilDigitaliseringsdirektoratet<br> 
...
**1.5** - Endre URL i nettleser tilDigitaliseringsdirektoratet[test-tenesteeigar](https://idporten-sptest2.difi.no/testsp). Vel konfigurasjon «*idporten-ver2*», eller «*idporten-ver1*», alt etter kva verifikasjonsmiljø tenesta er integrert mot.  
...
**2.5** - Endre URL i nettleser tilDigitaliseringsdirektoratet[test-tenesteeigar](https://idporten-sptest2.difi.no/testsp). Vel konfigurasjon «*idporten-ver2*», eller «*idporten-ver1*», alt etter kva verifikasjonsmiljø tenesta er integrert mot.    
...
**5.4** - 	Endre URL i nettleser tilDigitaliseringsdirektoratetsin test-tenesteeigar.  
...
**9.1** - 	Start ein ny nettlesarsesjon og gå tilDigitaliseringsdirektoratetsin test-tenesteeigar.  
