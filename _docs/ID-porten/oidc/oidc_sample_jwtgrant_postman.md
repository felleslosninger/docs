...
![keytool screenshot](assets/oidc_sample_jwtgrant_postman-7b70f6e0.png).
...
![run_generator screenshot](assets/oidc_sample_jwtgrant_postman-8e2e42d9.png)
...
![configure collection screenshot](assets/oidc_sample_jwtgrant_postman-828e7ff6.png)


Under the new Collection, create a new Request:

![new request screenshot](assets/oidc_sample_jwtgrant_postman-4b37ef54.png)

Make sure the request inherits the authenication settings from the parent Collection:

![request detail screenshot](assets/oidc_sample_jwtgrant_postman-630003c4.png)
