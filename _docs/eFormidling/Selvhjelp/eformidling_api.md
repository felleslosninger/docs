...
Hver blokk med innhold er én forsendelse(conversation), og kan fortelle viktige ting som: hvem avsender er, hvem mottaker er, tjeneste/forsendelsesmåte, meldingsId, forsendelsesId, forsendelsestidspunkt, [status](https://difi.github.io/felleslosninger/eformidling_selfhelp_traffic_flow.html) på forsendelsen. 

Det er viktig å forstå at statusene her forteller hvor langt forsendelsen er kommet og om mottaker har mottatt eller forsendelsen har feilet. Dette kan benyttes som verktøy for å være sikker på at forsendelsen er kommet frem til mottaker, se lenken over for liste over statuser for alle typer tjenester. 
