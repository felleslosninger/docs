...
Nødvendige forberedelser før en installerer eFormidling integrasjonspunktet.

## Dette gjør du før installasjon av Integrasjonspunktet

+ Bestille tilganger til tjenestene du skal benytte. [Les mer](bestille_tilganger)
...
+ Åpne nødvendige brannmuråpninger
+ Installere Java 8 X med JCE installert (JDK).
+ Virksomhetssertifikat utstedt av Buypass eller Commfides. [Les mer](virksomhetssertifikat)
+ Tidssynkronisering mellom server og NTP. 
+ Tips: Installer integrasjonspunktet og eInnsyn-klient på samme server ved bruk av eInnsyn
...
[VEILEDNING: Les alt om håndtering av virksomhetssertifikat her](sertifikatadministrasjon)
...
- [Integrasjonspunktet installasjon / installere integrasjonspunktet](installasjon#installasjon-av-integrasjonspunktet)
...
- [Integrasjonspunktet virksomhetssertifikat / sertifikatadministrasjon](sertifikatadministrasjon#integrasjonspunktet)
