...
3. last ned integrasjonspunkt[versjonsnummer].jar filen. Den finner du [her](https://beta-meldingsutveksling.difi.no/content/repositories/releases/no/difi/meldingsutveksling/integrasjonspunkt/2.0.4/integrasjonspunkt-2.0.4.jar)
