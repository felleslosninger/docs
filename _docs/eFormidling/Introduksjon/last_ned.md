...
> [**Integrasjonspunktet 2.17.0 (JAR)**](https://repo1.maven.org/maven2/no/difi/meldingsutveksling/integrasjonspunkt/2.17.0/integrasjonspunkt-2.17.0.jar)

> [**Signaturen finn du her**](https://repo1.maven.org/maven2/no/difi/meldingsutveksling/integrasjonspunkt/2.17.0/integrasjonspunkt-2.17.0.jar.asc)

> [**Integrasjonspunktet 2.17.0 (Docker container image)** ](https://hub.docker.com/layers/digdir/integrasjonspunkt/2.17.0/images/sha256-18bc4488e38994b421434250e67263eb4546203834c9fbf3c5621abd5cc180d6?context=explore)

`docker pull digdir/integrasjonspunkt:2.17.0`
