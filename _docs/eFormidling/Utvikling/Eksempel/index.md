...
Eksempler på bruk av eFormidling:

- [Eksempel på avtalt meldingsutveksling](avtalt)
- [Eksempel på FIKS IO-meldingsutveksling](fiks_io)
- [Eksempel på informasjon til innbygger](informasjon_til_innbygger)
- [Eksempel på innsynskrav fra eInnsyn](innsynskrav)
