...
| state | Recommended | Value set by the client and returned in the callback. If PKCE is not used, then state must be used to achieve CSRF-protection. Mandatory to use for public clients|
