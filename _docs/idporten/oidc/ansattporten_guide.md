...
Ansattporten testes også ut som pålogging til tjenester i allmenn sky (AWS, GCP, Azure). Eksempler på bruk:
...
Du kan lese [mer om dette her](ansattporten_allmennsky.html).
