...
| code_challenge   | Required*  | The [PKCE]({{site.baseurl}}oidc_func_pkce.html) `code_challenge` is a calculated value based on `code_verifier`.  Mandatory to use for public clients |
