...
ID-porten/Maskinporten har allerede [to eksisterende interne delegeringsmekanismer]({{site.baseurl}}/docs/ID-porten/oidc/oidc_api_admin#eierskap-til-integrasjoner), som ikke er kompatible med delegering i Altinn. For å oppnå korrekt registrering, må du da:
