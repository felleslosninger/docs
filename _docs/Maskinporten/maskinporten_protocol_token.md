...
The ‘aud’ field of the JWT must be set equal to the issuer identifier of maskinporten and must only contain a single value. Using the token-endpoint url as audience is deprecated and will be removed.
